  ...
  const SCENARIOS = {
    ...
    'Terrain G — Tuderberg Ring Ambush': {
      terrain: [
        ...
        { q: 11, r: 5, terrain: 'woods' },
        { q: 6, r: 5, terrain: 'rough' },
        { q: 7, r: 5, terrain: 'rough' },
        { q: 8, r: 5, terrain: 'rough' },
      ],
      units: [
        { q: 7, r: 5, side: 'blue', type: 'gen', quality: 'regular' },
        { q: 7, r: 7, side: 'blue', type: 'gen', quality: 'green' },
        ...
        { q: 8, r: 6, side: 'blue', type: 'inf', quality: 'regular' },
        ...
        { q: 9, r: 7, side: 'blue', type: 'cav', quality: 'regular' },
        { q: 7, r: 8, side: 'blue', type: 'skr', quality: 'green' },

        { q: 11, r: 5, side: 'red', type: 'gen', quality: 'regular' },
        { q: 4, r: 4, side: 'red', type: 'arc', quality: 'veteran' },
        { q: 5, r: 3, side: 'red', type: 'arc', quality: 'veteran' },
        { q: 9, r: 3, side: 'red', type: 'arc', quality: 'veteran' },
        { q: 10, r: 4, side: 'red', type: 'arc', quality: 'veteran' },
        { q: 10, r: 6, side: 'red', type: 'arc', quality: 'veteran' },
        { q: 4, r: 6, side: 'red', type: 'arc', quality: 'regular' },
        { q: 3, r: 5, side: 'red', type: 'skr', quality: 'veteran' },
        { q: 5, r: 8, side: 'red', type: 'skr', quality: 'veteran' },
        { q: 9, r: 8, side: 'red', type: 'skr', quality: 'veteran' },
        { q: 11, r: 6, side: 'red', type: 'skr', quality: 'veteran' },
        { q: 4, r: 5, side: 'red', type: 'inf', quality: 'regular' },
        { q: 10, r: 5, side: 'red', type: 'inf', quality: 'regular' },
        { q: 7, r: 9, side: 'red', type: 'inf', quality: 'regular' },
        { q: 2, r: 5, side: 'red', type: 'cav', quality: 'regular' },
        { q: 12, r: 5, side: 'red', type: 'cav', quality: 'green' },
      ],
    },
    ...
    'Terrain H — Feigned Retreat In The Narrows': {
      ...
      units: [
        { q: 6, r: 1, side: 'blue', type: 'gen', quality: 'regular' },
        ...
        { q: 11, r: 2, side: 'blue', type: 'cav', quality: 'regular' },
        { q: 5, r: 1, side: 'blue', type: 'arc', quality: 'regular' },
        { q: 8, r: 1, side: 'blue', type: 'arc', quality: 'regular' },
        { q: 4, r: 3, side: 'blue', type: 'skr', quality: 'regular' },
        { q: 10, r: 3, side: 'blue', type: 'skr', quality: 'regular' },
        { q: 7, r: 3, side: 'blue', type: 'inf', quality: 'green' },

        { q: 7, r: 9, side: 'red', type: 'gen', quality: 'regular' },
        { q: 5, r: 9, side: 'red', type: 'gen', quality: 'green' },
        { q: 6, r: 6, side: 'red', type: 'inf', quality: 'green' },
        { q: 7, r: 6, side: 'red', type: 'inf', quality: 'green' },
        { q: 8, r: 6, side: 'red', type: 'inf', quality: 'green' },
        { q: 5, r: 6, side: 'red', type: 'skr', quality: 'veteran' },
        { q: 9, r: 6, side: 'red', type: 'skr', quality: 'veteran' },
        { q: 5, r: 8, side: 'red', type: 'inf', quality: 'veteran' },
        { q: 6, r: 8, side: 'red', type: 'inf', quality: 'veteran' },
        { q: 8, r: 8, side: 'red', type: 'inf', quality: 'veteran' },
        { q: 9, r: 8, side: 'red', type: 'inf', quality: 'veteran' },
        { q: 3, r: 8, side: 'red', type: 'cav', quality: 'veteran' },
    ...
    'Terrain I — Veteran Ridge Breakthrough': {
      ...
      units: [
        ...
        { q: 7, r: 1, side: 'blue', type: 'gen', quality: 'regular' },
        { q: 4, r: 1, side: 'blue', type: 'arc', quality: 'veteran' },
        { q: 8, r: 1, side: 'blue', type: 'arc', quality: 'veteran' },
        ...
        { q: 5, r: 3, side: 'blue', type: 'skr', quality: 'veteran' },
        { q: 8, r: 3, side: 'blue', type: 'skr', quality: 'veteran' },
        { q: 3, r: 2, side: 'blue', type: 'cav', quality: 'veteran' },
        ...
        { q: 6, r: 8, side: 'red', type: 'arc', quality: 'veteran' },
        { q: 8, r: 8, side: 'red', type: 'arc', quality: 'veteran' },
        { q: 5, r: 7, side: 'red', type: 'skr', quality: 'veteran' },
        { q: 9, r: 7, side: 'red', type: 'skr', quality: 'veteran' },
        { q: 11, r: 8, side: 'red', type: 'cav', quality: 'veteran' },
        { q: 3, r: 8, side: 'red', type: 'cav', quality: 'green' },
      ],
    },
    ...
    'Terrain J — Twin Fords Veteran Stand': {
      terrain: [
        ...
        { q: 6, r: 4, terrain: 'woods' },
        { q: 8, r: 4, terrain: 'woods' },
        { q: 5, r: 6, terrain: 'woods' },
        { q: 6, r: 6, terrain: 'woods' },
        { q: 8, r: 6, terrain: 'woods' },
        { q: 9, r: 6, terrain: 'woods' },
      ...
      units: [
        { q: 6, r: 1, side: 'blue', type: 'gen', quality: 'veteran' },
        { q: 8, r: 1, side: 'blue', type: 'gen', quality: 'regular' },
        { q: 7, r: 1, side: 'blue', type: 'run', quality: 'green' },
        { q: 6, r: 0, side: 'blue', type: 'arc', quality: 'veteran' },
        ...
        { q: 9, r: 3, side: 'blue', type: 'cav', quality: 'veteran' },
        { q: 7, r: 3, side: 'blue', type: 'skr', quality: 'veteran' },
        { q: 4, r: 2, side: 'blue', type: 'inf', quality: 'regular' },
        { q: 9, r: 2, side: 'blue', type: 'inf', quality: 'regular' },
        { q: 10, r: 2, side: 'blue', type: 'inf', quality: 'regular' },
