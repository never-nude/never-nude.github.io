  ...
  function renderUnits() {
    ...
    for (const u of state.units) {
      ...
      if (u.type === "INF") {
        ...
        shape.setAttribute("x","-12"); shape.setAttribute("y","-10");
        shape.setAttribute("width","24"); shape.setAttribute("height","20");
        shape.setAttribute("rx","4");
      } else if (u.type === "CAV") {
        shape = document.createElementNS("http://www.w3.org/2000/svg","polygon");
        shape.setAttribute("points","0,-12 12,0 0,12 -12,0");
      } else if (u.type === "ARC") {
        shape = document.createElementNS("http://www.w3.org/2000/svg","polygon");
        shape.setAttribute("points","0,-12 12,10 -12,10");
      } else if (u.type === "GEN") {
